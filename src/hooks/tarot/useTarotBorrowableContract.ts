...
const abi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'kinkBorrowRate', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newAdjustSpeed', type: 'uint256' }],
    name: 'NewAdjustSpeed',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newBorrowTracker', type: 'address' }],
    name: 'NewBorrowTracker',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newKinkUtilizationRate', type: 'uint256' }],
    name: 'NewKinkUtilizationRate',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newReserveFactor', type: 'uint256' }],
...
export const useTarotBorrowableContract = () => {
  const addresses = useTarotBorrowableContractAddress()
...
export const useTarotBorrowableContractAddress = () => {
  ...
  return useMemo(
    () =>
      ({
        [fantom.id]: {
          usdc: '0xDb68f7EB74ddaaB1db4045A071e48e5BA9777d6C',
          ftm: '0x47c7B3f5Fa0d52Dfd51bB04977235adBE32a3002',
        },
      }[chain.id]),
    [chain]
  )
